...
int main()
{
    ...
    system("src\\main\\lib\\wget.exe -e use_proxy=yes -e https_proxy=127.0.0.1:7890 --no-check-certificate --output-document=teach.zip https://github.com/tomh500/SqaureModsMarket/releases/download/ItemsTeachPic/teach.zip");
